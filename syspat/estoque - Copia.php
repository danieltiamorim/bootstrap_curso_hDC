			...
			<div id="cadastro">
				<div class="container"> 
					...
					<table>	
							...
							<tr>
								<div class="row data">
									<div class="col-9">
										...
										<option value=" usado_aceitavel"> Usado - Aceitável</option>
										</select>
											</td>
									<br />
								</div>
						...
						<tr>
							<div class="row data">
								...
								<td> <input type="Preço" name="preco_venda" placeholder="Ex: 10,00" size="20"   maxlength="7" required/> </li> </td>
								</div>
							</div>
						</tr>
								...
								<div class="row data">
										<div class="col-9">
											...
											<td>	<input type="text" name="preco_custo" placeholder="Ex: 9,99" maxlength="7"  /> </li> </td>
								</div>
							</div>
						</tr>
					...
					<tr>
								...
								<textarea rows="4" placeholder="Ex: Livro com capa amassada, lateral rasgada, e amarelada, marcas de uso, assinatura do último dono, e autógrafo autor. Mas nada que impeça uma leitura prazerosa." name='descricao' width="100" > </textarea><br /><br /> </li>
							</td>
