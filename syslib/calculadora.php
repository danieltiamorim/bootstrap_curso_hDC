          ...
          <div id="cadastro">
            <div class="container"> 
              <div class="row">
                ...
                <h4 class="main-title"><u>Incluir</u></h4> 

 
                <form method="get" action="calculadora.php">
                Adicionar:<input type="text" name="pesquisar" placeholder="ISBN, Autor, Editora ou Título" size="50">
  ...
  "   <td>".$exibe['autor']."</td>",
    ...
    "   <td>".$exibe['estante']."</td>",
     ...
     "   <td>".$exibe['quantidade']."</td>",
      ...
      "   <td>".$exibe['estado']."</td>",
      "   <td>".$exibe['edicao']."</td>",
       " <h1>  <td>".$exibe['peso']." Gramas</td></h1>",
       "   <td>".$exibe['ID_estante']."</td>",
      " </tr>",
      
      $valor=$peso*0.025,
      " <h1>Peso =  ".$exibe['peso']." Gramas   ---------- VALOR = R$ ".$valor."  <h1>";

      foreach ($exibe=mysqli_fetch_assoc($exibe['peso'])+($exibe['peso'])
        $var_dump=$exibe['peso']);
}
